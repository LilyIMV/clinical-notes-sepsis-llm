...
\copy sofa_delta FROM '../../output/query/sofa_delta.csv' DELIMITER ',' CSV HEADER NULL ''
...
\copy ( SELECT * FROM cases_hourly_ex1c cv) To '../../output/query/q13_cases_hourly_ex1c.csv' with CSV HEADER;
\copy ( SELECT * FROM controls_hourly cv) To '../../output/query/q13_controls_hourly.csv' with CSV HEADER;
