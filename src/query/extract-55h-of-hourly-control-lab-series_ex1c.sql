...
- AUTHOR (of this version): Michael Moor, October 2018, Edited: Lily Voge 2025
---------------------------------------------------------------------------------------------------------------------
*/
...
DROP MATERIALIZED VIEW IF EXISTS control_55h_hourly_labs_binned CASCADE;

CREATE MATERIALIZED VIEW control_55h_hourly_labs_binned AS
SELECT 
  icustay_id,
  subject_id,
  chart_time,
  ...
  Ferritin, Transferrin, CreatineKinase, CK_MB, D_Dimer, NTproBNP,
  SedimentationRate, Fibrinogen, LDH, Magnesium, Calcium_free,
  pO2_bloodgas, pH_bloodgas, pCO2_bloodgas, SO2_bloodgas,
  Troponin_T, Glucose_CSF, Total_Protein_Joint_Fluid,
  Total_Protein_Pleural, Urine_Albumin_Creatinine_ratio, WBC_Ascites
FROM control_55h_hourly_labs_ex1c
