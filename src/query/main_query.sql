...
\copy ( SELECT * FROM sofa_table order by icustay_id, time_window) To '../../output/query/sofa_table.csv' with CSV HEADER;
\copy ( SELECT icustay_id, si_starttime FROM suspinfect_poe) To '../../output/query/si_starttime.csv' with CSV HEADER;
