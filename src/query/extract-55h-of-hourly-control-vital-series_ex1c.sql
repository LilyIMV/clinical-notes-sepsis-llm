...
DROP MATERIALIZED VIEW IF EXISTS control_55h_hourly_vitals_binned CASCADE;

CREATE MATERIALIZED VIEW control_55h_hourly_vitals_binned AS
SELECT
    icustay_id,
    subject_id,
    chart_time,
    ...
    FiO2,
    CRP
FROM control_55h_hourly_vitals_ex1c
