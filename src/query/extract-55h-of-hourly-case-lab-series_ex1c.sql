...
DROP MATERIALIZED VIEW IF EXISTS case_55h_hourly_labs_binned CASCADE;

CREATE MATERIALIZED VIEW case_55h_hourly_labs_binned AS
SELECT 
  icustay_id,
  subject_id,
  chart_time,
...
FROM case_55h_hourly_labs_ex1c
